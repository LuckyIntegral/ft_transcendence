...
class Game3D {
    ...
    drawEndGameMessage(message) {
        ...
        this.ctx.fillText(message, GameConstants.GAME_WIDTH / 2, GameConstants.GAME_HEIGHT / 2 - 50);
        this.ctx.font = "30px Arial";
        this.ctx.fillText("Click to play again", GameConstants.GAME_WIDTH / 2, GameConstants.GAME_HEIGHT / 2 + 50);
    }
